...
public class ChunkRepositoryImpl implements ChunkRepository {
    ...
    private ChunkRepository aspectForNewChunk = null;

    public ChunkRepositoryImpl(ChunkMapper dbMapper) {
     ...
     */
    public void setAspectForNewChunk(ChunkRepository aspectForNewChunk) {
